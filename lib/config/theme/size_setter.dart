import '../../models/enums/horizontal_screen_padding.dart';
import '../../models/enums/screen_size.dart';
...
class SizeSetter {
  ...
  static double getDisplayLargeSize() {
    return _getValueByScreenSize(xs: 58, sm: 64, md: 64, xl: 68);
  }
  ...
  static double getDisplaySmallSize() {
    return _getValueByScreenSize(xs: 34, sm: 34, md: 36, xl: 39);
  }
  ...
  static double getTitleSmallSize() {
    return _getValueByScreenSize(xs: 15, sm: 18, md: 18, xl: 20);
  }
  ...
  static double getLabelLargeSize() {
    return _getValueByScreenSize(xs: 12, sm: 14, md: 14, xl: 15);
  }
